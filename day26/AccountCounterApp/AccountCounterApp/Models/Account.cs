...
namespace AccountCounterApp.Models
{
    class Account
    {
        ...
        private static int _instanceCounter;//intiliaze it via a method c
        ...
        public static int HeadCount//static method,affinity ,uses only sttatic variables
        {
            get
            {
